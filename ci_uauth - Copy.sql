...
--
-- Table structure for table `udevs_email_templates`
--

DROP TABLE IF EXISTS `udevs_email_templates`;
CREATE TABLE `udevs_email_templates` (
...
--
-- Dumping data for table `udevs_email_templates`
--

INSERT INTO `udevs_email_templates` (`id`, `email_slug`, `email_template_for`, `email_template_body`, `available_variable`, `status`) VALUES
...
--
-- Table structure for table `udevs_users`
--

DROP TABLE IF EXISTS `udevs_users`;
CREATE TABLE `udevs_users` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `udevs_users`
--

INSERT INTO `udevs_users` (`id`, `user_role`, `username`, `email`, `password`, `first_name`, `last_name`, `gender`, `profile_picture`, `remember_key`, `recovery_key`, `activation_key`, `activated`, `activated_date`, `status`, `banned`, `banned_date`, `banned_till`, `created_date`, `ip_address`, `last_login`, `logged_in`) VALUES
...
(3, 4, 'alert&#40;\'WTF\'&#41;', 'cseroyiu@gmail.com', '$2y$10$ek5unXLG2EJppFw8RUn.KOJcKqspa1mIDc9PeZt932uCUt5X0AZpW', 'alert&#40;\'WTF\'&#41;', 'alert&#40;\'WTF\'&#41;', 0, '', '', '', '5b39c1188456e', 0, '0000-00-00 00:00:00', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '0000-00-00 00:00:00', 0),
...
--
-- Table structure for table `udevs_variables`
--

DROP TABLE IF EXISTS `udevs_variables`;
CREATE TABLE `udevs_variables` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `udevs_variables`
--

INSERT INTO `udevs_variables` (`id`, `variable_name`, `variable_value`, `variable_type`, `status`) VALUES
...
--
-- Indexes for table `udevs_email_templates`
--
ALTER TABLE `udevs_email_templates`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `udevs_users`
--
ALTER TABLE `udevs_users`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `udevs_variables`
--
ALTER TABLE `udevs_variables`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `udevs_email_templates`
--
ALTER TABLE `udevs_email_templates`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `udevs_users`
--
ALTER TABLE `udevs_users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `udevs_variables`
--
ALTER TABLE `udevs_variables`
